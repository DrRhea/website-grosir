...
<div class="flex min-h-full flex-1">
  <div class="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
    <div class="mx-auto w-full max-w-sm lg:w-96">
      <div>
        ...
        <h2 class="mt-8 text-2xl font-bold leading-9 tracking-tight text-gray-900">Masuk sebagai Agen</h2>
      </div>

      <div class="mt-10">
        <div>
          <form action="/agen/masuk" method="POST" class="space-y-6">
        ...
        <div class="mt-10">
          ...
          <div class="mt-6 flex gap-4 justify-center">
            <span class="text-gray-400">Bukan Agen?</span>
            <a href="/grosir/masuk" class="text-indigo-600 hover:text-indigo-400 duration-150 font-semibold">Masuk sebagai Grosir</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="relative hidden w-0 flex-1 lg:block">
    <img class="absolute inset-0 h-full w-full object-cover" src="../img/login/login-agen.png" alt="">
  </div>
</div>
