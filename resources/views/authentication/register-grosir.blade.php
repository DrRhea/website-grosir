...
<div class="flex min-h-full flex-1">
  <div class="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
    <div class="mx-auto w-full max-w-sm lg:w-96">
      <div>
        ...
        <h2 class="mt-8 text-2xl font-bold leading-9 tracking-tight text-gray-900">Daftar menjadi Grosir</h2>
      </div>

      <div class="mt-10">
        <div>
          <form action="/grosir/daftar" method="POST" class="space-y-6">
            @csrf
            <div>
            ...
            <div>
              ...
              <div class="mt-2">
                <input id="password_confirmation" name="password_confirmation" type="password" class="block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 px-4" placeholder="Masukan konfirmasi password Anda">
              </div>
            </div>
        ...
        <div class="mt-10">
          ...
          <div class="mt-6 flex gap-4 justify-center">
            ...
            <a href="/grosir/masuk" class="text-indigo-600 hover:text-indigo-400 duration-150 font-semibold">Masuk disini</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="relative hidden w-0 flex-1 lg:block">
    <img class="absolute inset-0 h-full w-full object-cover" src="../img/login/register-grosir.png" alt="">
  </div>
</div>
