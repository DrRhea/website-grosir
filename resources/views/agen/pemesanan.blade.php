                ...
                <table class="min-w-full divide-y divide-gray-300">
                  ...
                  <tr>
                    <td class="w-full py-4 pl-4 pr-3 text-sm font-medium text-gray-900 max-w-0 sm:w-auto sm:max-w-none sm:pl-0">
                      ...
                      <dl class="font-normal lg:hidden">
                        <dt class="sr-only">Title</dt>
                        <dd class="mt-1 text-gray-700 truncate">Designer</dd>
                        <dt class="sr-only sm:hidden">Email</dt>
                        <dd class="mt-1 text-gray-500 truncate sm:hidden">courtney.henry@example.com</dd>
                      </dl>
                    </td>
                  ...
                  <tr>
                    <td class="w-full py-4 pl-4 pr-3 text-sm font-medium text-gray-900 max-w-0 sm:w-auto sm:max-w-none sm:pl-0">
                      ...
                      <dl class="font-normal lg:hidden">
                        <dt class="sr-only">Title</dt>
                        <dd class="mt-1 text-gray-700 truncate">Director of Product</dd>
                        <dt class="sr-only sm:hidden">Email</dt>
                        <dd class="mt-1 text-gray-500 truncate sm:hidden">tom.cook@example.com</dd>
                      </dl>
                    </td>
                  ...
                  <tr>
                    <td class="w-full py-4 pl-4 pr-3 text-sm font-medium text-gray-900 max-w-0 sm:w-auto sm:max-w-none sm:pl-0">
                      ...
                      <dl class="font-normal lg:hidden">
                        <dt class="sr-only">Title</dt>
                        <dd class="mt-1 text-gray-700 truncate">Copywriter</dd>
                        <dt class="sr-only sm:hidden">Email</dt>
                        <dd class="mt-1 text-gray-500 truncate sm:hidden">whitney.francis@example.com</dd>
                      </dl>
                    </td>
                  ...
                  <tr>
                    <td class="w-full py-4 pl-4 pr-3 text-sm font-medium text-gray-900 max-w-0 sm:w-auto sm:max-w-none sm:pl-0">
                      ...
                      <dl class="font-normal lg:hidden">
                        <dt class="sr-only">Title</dt>
                        <dd class="mt-1 text-gray-700 truncate">Senior Designer</dd>
                        <dt class="sr-only sm:hidden">Email</dt>
                        <dd class="mt-1 text-gray-500 truncate sm:hidden">leonard.krasner@example.com</dd>
                      </dl>
                    </td>
                  ...
                  <tr>
                    <td class="w-full py-4 pl-4 pr-3 text-sm font-medium text-gray-900 max-w-0 sm:w-auto sm:max-w-none sm:pl-0">
                      ...
                      <dl class="font-normal lg:hidden">
                        <dt class="sr-only">Title</dt>
                        <dd class="mt-1 text-gray-700 truncate">Principal Designer</dd>
                        <dt class="sr-only sm:hidden">Email</dt>
                        <dd class="mt-1 text-gray-500 truncate sm:hidden">floyd.miles@example.com</dd>
                      </dl>
                    </td>
