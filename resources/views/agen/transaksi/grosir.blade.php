                  ...
                  <div class="-mx-4 mt-8 sm:-mx-0">
                    <table class="min-w-full divide-y divide-gray-300">
                      ...
                      <tr>
                        ...
                        <th scope="col" class="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 lg:table-cell">Nomor Telefon</th>
                        <th scope="col" class="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 sm:table-cell">Alamat</th>
                      ...
                      <tr>
                        <td class="w-full max-w-0 py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:w-auto sm:max-w-none sm:pl-0">
                          ...
                          <dl class="font-normal lg:hidden">
                            ...
                            <dd class="mt-1 truncate text-gray-700">{{ $grosir->nomor_telefon_grosir }}</dd>
                        ...
                        <td class="hidden px-3 py-4 text-sm text-gray-500 lg:table-cell">{{ $grosir->nomor_telefon_grosir }}</td>
                        ...
                        <td class="py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                          <a href="#" class="text-indigo-600 hover:text-indigo-900">Edit<span class="sr-only">{{ $grosir->nama_grosir }}</span></a>
                        </td>
                      </tr>
                      @endforeach
