            ...
            <div class="px-4 sm:px-6 lg:px-8">
              <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                  ...
                  <p class="mt-2 text-sm text-gray-700">Berikut adalah daftar semua produk dengan nama, deskripsi, stok, harga, foto, dan status.</p>
                </div>
                <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                  <a href="/agen/produk/tambah/" type="button" class="block rounded-md bg-indigo-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Tambah Produk</a>
                </div>
              </div>
              <div class="-mx-4 mt-8 sm:-mx-0">
                <table class="min-w-full divide-y divide-gray-300">
                  ...
                  <tr>
                    ...
                    <th scope="col" class="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 xl:table-cell">Deskripsi</th>
                    <th scope="col" class="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 lg:table-cell">Harga</th>
                    <th scope="col" class="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 md:table-cell">Stok</th>
                    <th scope="col" class="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 sm:table-cell">Foto</th>
                  ...
                  @foreach($produks as $produk)
                    <tr>
                      ...
                      <td class="hidden px-3 py-4 text-sm text-gray-500 sm:table-cell">
                        <img src="{{ asset($produk->foto_produk) }}" alt="" class="w-12 h-16 object-cover rounded-md">
                      </td>
                      <td class="px-3 py-4 text-sm text-gray-500">
                        @if($produk->status == 'tersedia')
                          <span class="bg-green-100 text-green-800 text-sm font-medium me-2 px-2.5 py-2 rounded">
                      ...
                      <td class="py-4 pl-3 pr-4 text-center text-sm font-medium sm:pr-0 select-none">
                        <a href="#" class="text-indigo-600 hover:text-indigo-900 mr-2">Restok<span class="sr-only">Restock</span></a>
                        <span class="text-gray-300">|</span>
                        <a href="/agen/produk/edit/{{ Str::slug($produk->nama_produk) }}" class="text-indigo-600 hover:text-indigo-900 mx-2">Edit<span class="sr-only">Edit</span></a>
                        <span class="text-gray-300">|</span>
                        <a href="#" class="text-indigo-600 hover:text-indigo-900 ml-2">Hapus<span class="sr-only">Hapus</span></a>
                      </td>
                    </tr>
                  @endforeach
                  </tbody>
