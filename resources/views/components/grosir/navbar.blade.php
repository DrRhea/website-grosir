  ...
  <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
    ...
    <div class="hidden lg:flex lg:flex-1 lg:justify-end items-center gap-8">
      <div class="flex gap-4 items-center">
        <a href="/grosir/produk/keranjang" class="text-sm font-semibold leading-6 text-gray-900">
        ...
        <a href="/grosir/produk/wishlist" class="text-sm font-semibold leading-6 text-gray-900">
          <span aria-hidden="true">
