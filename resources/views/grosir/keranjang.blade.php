          ...
          <form class="mt-12">
              ...
              <ul role="list" class="border-t border-b border-gray-200 divide-y divide-gray-200">
                ...
                <li class="flex py-6">
                  <div class="flex-shrink-0">
                    <img src="{{ asset($keranjang->produk->foto_produk) }}" alt="{{ $keranjang->produk->deskripsi_produk }}." class="object-cover object-center w-24 h-24 rounded-md sm:h-32 sm:w-32 line-clamp-5">
                  </div>
                  ...
                  <div class="flex flex-col flex-1 ml-4 sm:ml-6">
                    <div>
                      <div class="flex justify-between">
                        ...
                        <p class="ml-4 text-sm font-medium text-gray-900 flex flex-col items-end">
                          <span>
            ...
            <section aria-labelledby="summary-heading" class="mt-10">
              ...
              <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Biaya pengiriman akan dihitung saat checkout.</p>
              </div>
