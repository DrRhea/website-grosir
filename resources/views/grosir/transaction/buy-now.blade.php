              ...
              <div class="mt-4 rounded-lg border border-gray-200 bg-white shadow-sm">
                <ul role="list" class="divide-y divide-gray-200">
                  <li class="flex px-4 py-6 sm:px-6">
                    <div class="flex-shrink-0">
                      <img src="{{ asset($produk->foto_produk) }}" alt="{{ $produk->nama_produk }}." class="w-20 rounded-md">
                    </div>
                    ...
                    <div class="ml-6 flex flex-1 flex-col">
                      <div class="flex">
                        <div class="min-w-0 flex-1">
                          <h4 class="text-sm">
                            <a href="#" class="font-medium text-gray-700 hover:text-gray-800">{{ ucwords($produk->nama_produk) }}</a>
                          </h4>
                          <p class="mt-1 text-sm text-gray-500 line-clamp-2 w-3/4">{{ $produk->deskripsi_produk }}</p>
                        </div>
                      </div>

                      <div class="mt-2">
                        <p class="mt-1 text-sm font-medium text-gray-500">Stok: {{ $produk->stok_realtime_produk }}</p>
                      </div>

                      <div class="flex flex-1 items-center justify-between pt-2 mt-2">
                        <p class="mt-1 text-sm font-medium text-gray-900">Rp{{ number_format($produk->harga_produk, 0, ',', '.') }}
                ...
                <dl class="space-y-6 border-t border-gray-200 px-4 py-6 sm:px-6">
                  <div class="flex items-center justify-between">
                    ...
                    <dd class="text-sm font-medium text-gray-900">Rp<span x-text="subtotal.toLocaleString('id-ID')"></span></dd>
                  </div>
                  <div class="flex items-center justify-between">
