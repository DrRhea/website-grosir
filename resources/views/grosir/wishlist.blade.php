            ...
            @forelse($wishlistsWithProducts as $item)
              <div class="group">
                <div class="relative w-full overflow-hidden bg-gray-200 rounded-lg aspect-h-1 aspect-w-1 xl:aspect-h-8 xl:aspect-w-7">
                  <img src="{{ asset($item['product']->foto_produk) }}" alt="{{ $item['product']->nama_produk }}" class="object-cover object-center w-full h-[300px] group-hover:scale-125 duration-300">
