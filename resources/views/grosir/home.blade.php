    ...
    <div class="px-6 py-16 rounded-2xl bg-gray-50 sm:p-16">
      <div class="max-w-xl mx-auto lg:max-w-none">
        <div class="text-center">
          <h2 class="text-2xl font-bold tracking-tight text-gray-900">Layanan Terbaik Kami</h2>
        </div>
        <div class="grid max-w-sm grid-cols-1 mx-auto mt-12 gap-x-8 gap-y-10 sm:max-w-none lg:grid-cols-3">
          <div class="text-center sm:flex sm:text-left lg:block lg:text-center">
              ...
              <div class="mt-3 sm:ml-6 sm:mt-0 lg:ml-0 lg:mt-6">
                <h3 class="text-sm font-medium text-gray-900">Pengiriman Cepat</h3>
                <p class="mt-2 text-sm text-gray-500">Kami menawarkan pengiriman cepat untuk memastikan telur ayam sampai di tempat Anda dengan kualitas terbaik.</p>
              </div>
            </div>
          <div class="text-center sm:flex sm:text-left lg:block lg:text-center">
              <div class="sm:flex-shrink-0">
              ...
              <div class="mt-3 sm:ml-6 sm:mt-0 lg:ml-0 lg:mt-6">
                <h3 class="text-sm font-medium text-gray-900">Kualitas Terjamin</h3>
                <p class="mt-2 text-sm text-gray-500">Kami memastikan setiap telur ayam yang Anda terima memiliki kualitas terbaik dan memenuhi standar kebersihan yang tinggi.</p>
              </div>
            </div>
          <div class="text-center sm:flex sm:text-left lg:block lg:text-center">
              <div class="sm:flex-shrink-0">
                <div class="flow-root">
                  <!-- Mengganti ikon ketiga dengan SVG yang disesuaikan -->
                  <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24" class="mx-auto" style="fill: rgba(0, 0, 0, 1);"><path d="M5 18v3.766l1.515-.909L11.277 18H16c1.103 0 2-.897 2-2V8c0-1.103-.897-2-2-2H4c-1.103 0-2 .897-2 2v8c0 1.103.897 2 2 2h1zM4 8h12v8h-5.277L7 18.234V16H4V8z"></path><path d="M20 2H8c-1.103 0-2 .897-2 2h12c1.103 0 2 .897 2 2v8c1.103 0 2-.897 2-2V4c0-1.103-.897-2-2-2z"></path></svg>
                </div>
              </div>
              <div class="mt-3 sm:ml-6 sm:mt-0 lg:ml-0 lg:mt-6">
                <h3 class="text-sm font-medium text-gray-900">Pelayanan Pelanggan</h3>
                <p class="mt-2 text-sm text-gray-500">Tim kami siap membantu Anda dengan semua pertanyaan dan kebutuhan terkait telur ayam yang Anda beli.</p>
              </div>
            </div>
        </div>
      </div>
